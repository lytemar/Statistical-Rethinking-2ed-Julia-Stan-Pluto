...
# ╔═╡ 0b7a94d0-bc5a-4e08-95cc-cccc6b0b5142
using Pkg

# ╔═╡ 4e9996df-caaf-4d91-895d-ef3d3e2a58b8
begin
	using Distributions
	using StatsPlots
	using StatsBase
...
# ╔═╡ e4d0a63c-e705-4d98-97ae-6da179a4a2d7
html"""
<style>
	main {
		margin: 0 auto;
...
# ╔═╡ 55da108c-51dc-4233-a1f5-3cc55bb25f7b
md" ## Clip-07-13-14s.jl"

# ╔═╡ 0546946d-a6c9-4c2d-9342-d0895f005180
begin
...
# ╔═╡ 46e38dd7-715e-4c5c-96e8-2835ef7ba6b2
df

# ╔═╡ 6393ae41-0756-4012-bc1d-ce4d45fa9243
begin
...
# ╔═╡ a7137ecb-3b58-4cc5-bd2e-0e3bc4d95245
md"
!!! note
...
# ╔═╡ d9825230-2488-43e0-97e6-c1ca2e67188e
stan7_2 = "
data {
...
# ╔═╡ f42d1994-aa9b-414e-910f-95697a03466c
begin
...
# ╔═╡ 3ce72e09-d21e-489c-bb41-aefd90d36e39
begin
	tmpdir = mktempdir()
	...
	for K in 1:6
		...
		if success(rc7_2s)
			global nt7_2s = read_samples(m7_2s, :namedtuple)
...
# ╔═╡ f42e89e4-dada-4725-a490-8f5abe8d0ec7
lppd_res'

# ╔═╡ 2d594ac5-e358-4919-93c8-6ede53694f59
-2sum(lppd_res', dims=1)

# ╔═╡ 986d21a4-4f44-4fbf-85a9-30c38e3b0625
md"
!!! note
...
# ╔═╡ 2da35b04-e068-4944-aa21-b5abb41d3b98
waic(nt7_2s.log_lik')

# ╔═╡ 07780d9d-d898-466a-9210-66fbd3d06d64
loo

# ╔═╡ 13682049-6a31-4e96-a3e3-5e8ba86d8e19
loos

# ╔═╡ a36c6934-10ef-4204-ba33-34b34a796dd0
sum.(loos)

# ╔═╡ 9abf8b41-b104-40f9-a9ce-92b46cfd9b7a
pk_qualify(pk[1])

# ╔═╡ a5d3a8e3-b288-4dd8-a06d-5a2bbdfdad63
pk_plot(pk[1]; title="PSIS diagnostic plot (K = 1)")

# ╔═╡ edfac264-6c19-4f43-97aa-4cba8235705c
begin
...
manifest_format = "2.0"
project_hash = "5328ecdac92ff1498b7904250b86cbb4d457ebf6"
...
git-tree-sha1 = "90c6a028de8b813557ff0c4afc29a9c95c6ba9ac"
